  ...
  <div id="content">
   ...
   <!-- 弹框 dom -->
    ...
    <div id="dialog_title" class="dialogtitle" style="">
        ...
        <el-button type="success" icon="el-icon-close" circle @click="closepop" style="float: right;margin-right: 10px; width:38px"></el-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    createWindMarker() {
      // var layer = null
      var markerfeature1 = this.creatWindFeature(this.currentwind)
      var markerfeature2 = this.creatWindFeature(this.prewind)

      // console.log(this.currentwind)

      // 设置标记样式
      console.log(markerfeature1)
      //当前时刻
      var img1 = this.checkpic(this.currentwind.wind,1)
      var img2 = this.checkpic(this.currentwind.wind,2)
      console.log(img1)
      markerfeature1.setStyle(
        new Style({
          image: new Icon({
            // src: require("@/assets/img/windblue.png"),
            src: require('@/assets/img/'+img1),
            scale: 1,
          }),
        }));
      // 设置标记样式
      markerfeature2.setStyle(
        new Style({
          image: new Icon({
            // src: require("@/assets/img/prewindblue.png"),
            src: require('@/assets/img/'+img2),
            scale: 1,
          }),
        }));
      // console.log(markerfeature1)
      this.addWindToMap(markerfeature1)
      this.addWindToMap(markerfeature2)
