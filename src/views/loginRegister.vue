          ...
          <div class="bform">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="200px" class="demo-ruleForm">
              ...
              <el-form-item class="btn">
                ...
                <el-button style="background-color: rgb(57,167,176);" type="primary" @click="login('ruleForm')" round>
                  立即登录
                </el-button>
        ...
        <div class="big-contain" key="bigContainRegister" v-else>
          ...
          <div class="bform">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="form" label-width="200px" class="demo-ruleForm">
              ...
              <el-form-item class="btn">
                <el-button style="background-color: rgb(57,167,176);" type="primary" @click="reject" round>立即注册
                </el-button>
                <!-- <el-button @click="resetForm('ruleForm')">重置</el-button> -->
              </el-form-item>
            </el-form>
  ...
  methods: {
    ...
    handleLoginValidation() {
      ...
      if (username !== 'admin' && username.length !== 0) {
        this.showErrorMessage('用户名不存在');
      } else if (password !== '111111' && password.length !== 0 && username.length !== 0) {
    ...
    handleSubmitForm() {
      const _this = this;
      _this.$axios.post("http://localhost:8080/login", _this.ruleForm)
        .then(res => {
          _this.processLoginResponse(res);
        });
    },
